...
export const PERMISSIONS = {
  ...
  emergency_access_log: { admin: "full", privacy_officer: "full", security_officer: "full", compliance_manager: "read_only", auditor: "read_only", data_analyst: "none", developer: "none" },
  encryption_inventory: { admin: "full", privacy_officer: "none", security_officer: "full", compliance_manager: "read_only", auditor: "read_only", data_analyst: "none", developer: "full" },
  ...
  findings_remediation: { admin: "full", privacy_officer: "full", security_officer: "full", compliance_manager: "full", auditor: "read_only", data_analyst: "none", developer: "none" },
  ...
  controls_checklist: { admin: "full", privacy_officer: "full", security_officer: "full", compliance_manager: "full", auditor: "read_only", data_analyst: "none", developer: "none" },
  ...
  policy_acknowledgements: { admin: "full", privacy_officer: "full", security_officer: "read_only", compliance_manager: "full", auditor: "read_only", data_analyst: "none", developer: "none" },
  sanctions_log: { admin: "full", privacy_officer: "full", security_officer: "read_only", compliance_manager: "full", auditor: "read_only", data_analyst: "none", developer: "none" },
  incident_intake: { admin: "full", privacy_officer: "full", security_officer: "full", compliance_manager: "full", auditor: "none", data_analyst: "none", developer: "full" },
  ...
  scheduled_reports: { admin: "full", privacy_officer: "full", security_officer: "read_only", compliance_manager: "full", auditor: "read_only", data_analyst: "none", developer: "none" },
  ...
  billing_plan: { admin: "full", privacy_officer: "none", security_officer: "none", compliance_manager: "none", auditor: "none", data_analyst: "none", developer: "none" },
};
...
export const PAGE_LABELS = {
  ...
  emergency_access_log: "Emergency access log",
  encryption_inventory: "Encryption inventory",
  ...
  findings_remediation: "Findings & remediation",
...
export const ROUTE_TO_PAGE = {
  ...
  "/dashboard/emergency-access-log": "emergency_access_log",
  "/dashboard/encryption-inventory": "encryption_inventory",
  ...
  "/dashboard/findings-remediation": "findings_remediation",
  "/dashboard/policy-library": "policy_library",
  "/dashboard/controls-checklist": "controls_checklist",
  ...
  "/dashboard/policy-acknowledgements": "policy_acknowledgements",
  "/dashboard/sanctions-log": "sanctions_log",
  "/dashboard/incident-intake": "incident_intake",
  ...
  "/dashboard/scheduled-reports": "scheduled_reports",
  ...
  "/dashboard/billing-plan": "billing_plan",
};
