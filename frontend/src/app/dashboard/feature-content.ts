...
export const featureSpecs: FeatureSpec[] = [
  ...
  },
  {
    ...
    purpose:
      "Track every break-glass access event with who, what, when, and why.",
    roles: ["Security Officer", "Privacy Officer", "Auditor"],
    primaryAction: "Review events",
    secondaryAction: "Create incident",
    status: "WARNING",
    statusLabel: "Needs review",
    metrics: [
      { label: "Break-glass events", value: "6", context: "Last 30 days", trendPercent: 4, trendPositive: false },
      { label: "Unreviewed", value: "1", context: "Past 24 hours", trendPercent: 1, trendPositive: false },
      { label: "Justified", value: "5", context: "Reviewed events", trendPercent: 9 },
    ],
    workflow: [
      "Review actor, target, time, and reason.",
      "Mark access justified or unjustified.",
      "Create incident for suspicious use.",
    ],
    table: {
      headers: ["Actor", "Target", "Reason", "Review"],
      rows: [
        ["Nurse Admin", "Patient record", "Emergency treatment", "Justified"],
        ["Ops Admin", "Claims export", "Support escalation", "Pending"],
        ["Security Lead", "Audit logs", "Investigation", "Justified"],
      ],
    },
    emptyState: {
      title: "No emergency access events",
      description: "Break-glass activity will appear here for review.",
    },
  },
]
...
const moreSpecs: FeatureSpec[] = [
  {
    ...
    purpose:
      "Track PHI systems, encryption methods, TLS posture, and key management state.",
    roles: ["Security Officer", "Developer"],
    primaryAction: "Add system",
    secondaryAction: "Upload evidence",
    status: "PASS",
    statusLabel: "Mostly covered",
    metrics: [
      { label: "Encrypted systems", value: "21 / 22", context: "PHI inventory", trendPercent: 4 },
      { label: "Key rotation gaps", value: "2", context: "Need owner review", trendPercent: 2, trendPositive: false },
      { label: "TLS 1.2+", value: "100%", context: "External endpoints", trendPercent: 1 },
    ],
    workflow: ["Add PHI system.", "Record encryption and key details.", "Attach evidence.", "Flag exceptions."],
    table: {
      headers: ["System", "Encryption", "Key Management", "Status"],
      rows: [
        ["EHR warehouse", "AES-256", "KMS managed", "Pass"],
        ["Billing DB", "AES-256", "Customer managed", "Pass"],
        ["Legacy export", "Unknown", "Missing", "Warning"],
      ],
    },
    emptyState: { title: "No encryption inventory", description: "Add PHI systems to track encryption coverage." },
  },
  {
...
const finalSpecs: FeatureSpec[] = [
  ...
  },
  {
    ...
    purpose: "Track open findings with owner, severity, due date, evidence, and verification.",
    roles: ["Compliance Manager", "Security Officer", "Developer"],
    primaryAction: "Create finding",
    secondaryAction: "Bulk assign",
    status: "WARNING",
    statusLabel: "8 open",
    metrics: [
      { label: "Open findings", value: "8", context: "Remediation backlog", trendPercent: 9, trendPositive: false },
      { label: "Overdue", value: "2", context: "Needs escalation", trendPercent: 2, trendPositive: false },
      { label: "Verified", value: "14", context: "This quarter", trendPercent: 12 },
    ],
    workflow: ["Triage finding.", "Assign owner and due date.", "Owner uploads remediation evidence.", "Verifier closes or rejects."],
    table: { headers: ["Finding", "Owner", "Due", "Status"], rows: [["PHI in logs", "Engineering", "Apr 30", "In progress"], ["Expired BAA", "Privacy", "May 03", "Open"], ["Training overdue", "HR", "May 05", "Pending"]] },
    emptyState: { title: "No open findings", description: "Confirmed risks and control gaps will appear here." },
  },
  {
  ...
  },
  {
    ...
    purpose: "Map controls to HIPAA Security Rule administrative, physical, and technical safeguards.",
    roles: ["Compliance Manager", "Auditor"],
    primaryAction: "Update control",
    secondaryAction: "Export checklist",
    status: "WARNING",
    statusLabel: "61 / 75 pass",
    metrics: [
      { label: "Passing controls", value: "61", context: "Of 75 specs", trendPercent: 6 },
      { label: "Evidence gaps", value: "9", context: "Needs upload", trendPercent: 4, trendPositive: false },
      { label: "Failed controls", value: "5", context: "Create findings", trendPercent: 2, trendPositive: false },
    ],
    workflow: ["Review safeguard domain.", "Set implementation status.", "Attach evidence.", "Open related findings."],
    table: { headers: ["Control", "Domain", "Evidence", "Status"], rows: [["Access Control", "Technical", "Uploaded", "Pass"], ["Contingency Plan", "Administrative", "Missing", "Warning"], ["Facility Access", "Physical", "Uploaded", "Pass"]] },
    emptyState: { title: "No controls loaded", description: "Import the HIPAA controls checklist to begin tracking implementation." },
  },
  {
  ...
  },
  {
    ...
    purpose: "Track who signed each HIPAA policy and which version they acknowledged.",
    roles: ["Privacy Officer", "Compliance Manager"],
    primaryAction: "Request acknowledgement",
    secondaryAction: "Send reminders",
    status: "WARNING",
    statusLabel: "23 pending",
    metrics: [
      { label: "Acknowledged", value: "89%", context: "Published policies", trendPercent: 6 },
      { label: "Pending", value: "23", context: "Staff sign-offs", trendPercent: 8, trendPositive: false },
      { label: "Policy versions", value: "11", context: "Tracked", trendPercent: 2 },
    ],
    workflow: ["Publish policy.", "Request acknowledgement.", "Send reminders.", "Export sign-off evidence."],
    table: { headers: ["Policy", "Version", "Pending", "Last sent"], rows: [["Privacy Rule", "v3.1", "9", "Apr 24"], ["Security Rule", "v2.4", "11", "Apr 22"], ["Sanctions", "v1.2", "3", "Apr 20"]] },
    emptyState: { title: "No acknowledgement requests", description: "Publish a policy and request staff sign-off." },
  },
  {
    href: "/dashboard/sanctions-log",
    section: "Workforce",
    title: "Sanctions Log",
    purpose: "Document disciplinary actions for HIPAA violations with controlled access.",
    roles: ["Privacy Officer", "Compliance Manager", "HR/Admin"],
    primaryAction: "Add sanction",
    secondaryAction: "Link incident",
    status: "PASS",
    statusLabel: "Restricted",
    metrics: [
      { label: "Logged actions", value: "3", context: "Restricted records", trendPercent: 1, trendPositive: false },
      { label: "Linked incidents", value: "3", context: "Evidence complete", trendPercent: 3 },
      { label: "Open reviews", value: "0", context: "No pending actions", trendPercent: 2 },
    ],
    workflow: ["Log sanction.", "Link incident or finding.", "Attach evidence.", "Restrict visibility."],
    table: { headers: ["Case", "Violation", "Action", "Access"], rows: [["SAN-001", "Unauthorized access", "Written warning", "Restricted"], ["SAN-002", "Policy breach", "Training assigned", "Restricted"], ["SAN-003", "Repeated violation", "Suspension", "Restricted"]] },
    emptyState: { title: "No sanctions logged", description: "Document disciplinary actions when required by policy." },
  },
]

const incidentAndReportSpecs: FeatureSpec[] = [
  {
    href: "/dashboard/incident-intake",
    section: "Incidents & Breach",
    title: "Incident Intake",
    purpose: "Log a new potential breach or security event with required triage fields.",
    roles: ["All users", "Security Officer", "Privacy Officer"],
    primaryAction: "Log incident",
    secondaryAction: "Save draft",
    status: "PENDING",
    statusLabel: "Ready",
    metrics: [
      { label: "Drafts", value: "2", context: "Incomplete intake", trendPercent: 1, trendPositive: false },
      { label: "Submitted", value: "7", context: "This month", trendPercent: 4 },
      { label: "PHI unknown", value: "3", context: "Needs triage", trendPercent: 3, trendPositive: false },
    ],
    workflow: ["Capture reporter and discovery time.", "Identify systems and PHI involvement.", "Attach evidence.", "Submit to triage queue."],
    table: { headers: ["Field", "Purpose", "Required", "Owner"], rows: [["Reporter", "Who found it", "Yes", "Submitter"], ["PHI involved", "Breach triage", "Yes", "Privacy"], ["Affected count", "Notification threshold", "If known", "Privacy"]] },
    emptyState: { title: "No incident drafts", description: "Use the intake form to log a security event or potential breach." },
  },
  {
  ...
  },
  {
    ...
    purpose: "Automate weekly or monthly reports to stakeholders.",
    roles: ["Compliance Manager"],
    ...
    metrics: [
      { label: "Schedules", value: "3", context: "Active automations", trendPercent: 1 },
      { label: "Recipients", value: "12", context: "Stakeholders", trendPercent: 2 },
      { label: "Failed runs", value: "0", context: "Last 30 days", trendPercent: 1 },
    ],
    workflow: ["Choose template.", "Set frequency.", "Add recipients.", "Monitor last and next run."],
    table: { headers: ["Schedule", "Frequency", "Recipients", "Next run"], rows: [["Weekly risk digest", "Weekly", "Security", "Monday"], ["Training status", "Monthly", "HR", "May 1"], ["BAA expirations", "Monthly", "Privacy", "May 3"]] },
    emptyState: { title: "No scheduled reports", description: "Create a recurring report for stakeholders." },
  },
  {
...
const settingsSpecs: FeatureSpec[] = [
  ...
  },
  {
    ...
    section: "Settings",
    title: "Billing & Plan",
    purpose: "Manage plan tier, usage counters, billing contact, and invoices.",
    ...
    statusLabel: "Active",
    metrics: [
      { label: "Plan", value: "Pro", context: "Active tier", trendPercent: 1 },
      { label: "Usage", value: "68%", context: "Monthly scan quota", trendPercent: 12, trendPositive: false },
      { label: "Invoices", value: "12", context: "Available", trendPercent: 1 },
    ],
    workflow: ["Review plan.", "Monitor usage.", "Update billing contact.", "Download invoices."],
    table: { headers: ["Invoice", "Date", "Amount", "Status"], rows: [["INV-042", "Apr 01", "$499", "Paid"], ["INV-041", "Mar 01", "$499", "Paid"], ["INV-040", "Feb 01", "$499", "Paid"]] },
    emptyState: { title: "No billing data", description: "Billing details will appear after a plan is connected." },
  },
]
